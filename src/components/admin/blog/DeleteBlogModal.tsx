...
export default function DeleteBlogModal({ open, onClose, onDeleted, postId, postTitle }: Props) {
                ...
                >
                    ...
                    >
                        ...
                        <div className="p-6">
                            ...
                            <h3 className="mt-4 text-[17px] font-bold text-slate-900">Delete this post?</h3>
                            <p className="mt-1.5 text-[13px] leading-relaxed text-slate-500">
                                {postTitle ? (
                                    <>
                                        <span className="font-semibold text-slate-700">&ldquo;{postTitle}&rdquo;</span> will be permanently deleted. This action cannot be undone.
                                    </>
                                ) : (
